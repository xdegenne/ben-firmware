...
# 0.0.14 (provisioning manuel) doivent être alignés à 0.0.15 — qui contient
...
set -euo pipefail
echo "[update pi-0.0.14 → pi-0.0.15] no-op (alignement version seulement)"
echo "[update pi-0.0.14 → pi-0.0.15] ✓ done"
