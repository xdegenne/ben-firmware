...
REAL_FRAMES = {
    ...
    #   ADCO 021861000000. C'est LA trame sur laquelle l'émetteur LoRa v0.5.1 fait rouge rouge.
    "ben0003_histo_hc_prod": {
        "mode": "histo",
        "b64": ("AgpBRENPIDAyMTg2MTAwMDAwMCApDQpPUFRBUklGIEhDLi4gPA0KSVNPVVNDIDQ1ID8NCkhDSEMgMDMw"
